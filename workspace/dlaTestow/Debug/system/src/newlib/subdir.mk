...
system/src/newlib/%.o: ../system/src/newlib/%.cpp
	...
	arm-none-eabi-g++ -mcpu=cortex-m3 -march=armv7-m -mthumb -mlittle-endian -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wall -Wextra  -g3 -DDEBUG -DUSE_FULL_ASSERT -DTRACE -DOS_USE_TRACE_SEMIHOSTING_DEBUG -DSTM32F2XX -DUSE_STDPERIPH_DRIVER -DHSE_VALUE=96000000 -I"C:\CLib-performance-analysis-platform\libs\Drivers\CMSIS\Include" -I"C:\CLib-performance-analysis-platform\libs\Drivers\STM32F2xx_HAL_Driver\Inc" -I"C:\CLib-performance-analysis-platform\libs\Drivers\CMSIS\Device\ST\STM32F2xx\Include" -std=gnu++11 -fabi-version=0 -fno-exceptions -fno-rtti -fno-use-cxa-atexit -fno-threadsafe-statics -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
